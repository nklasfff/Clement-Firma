...
var I18N = {
  ...
  ui: {
    da: {
      ...
      notifTitle: 'Nyt indhold',
      notifDesc: 'Skriv dig op, så får du besked når der tilføjes nye øvelser eller refleksioner. Vi sender kun relevante opdateringer — aldrig spam.',
      notifToggle: 'Hold mig opdateret',
      notifEmailPlaceholder: 'Din email',
      notifSave: 'Tilmeld',
      notifSaved: 'Du er tilmeldt! Vi sender kun besked når der er noget nyt og relevant.',
      notifError: 'Indtast en gyldig email-adresse.',
      notifOffline: 'Din tilmelding er gemt lokalt. Den sendes automatisk når appen er forbundet.',
      language: 'Sprog',
      langDanish: 'Dansk',
      langEnglish: 'English',
    ...
    en: {
      ...
      appVersion: 'Clement WellbeingAtWork v1.0',
      notifTitle: 'New content',
      notifDesc: 'Sign up to be notified when new exercises or reflections are added. We only send relevant updates — never spam.',
      notifToggle: 'Keep me updated',
      notifEmailPlaceholder: 'Your email',
      notifSave: 'Subscribe',
      notifSaved: 'You\'re subscribed! We\'ll only reach out when there\'s something new and relevant.',
      notifError: 'Please enter a valid email address.',
      notifOffline: 'Your subscription is saved locally. It will be sent automatically when the app connects.',
      language: 'Language',
      langDanish: 'Dansk',
      langEnglish: 'English',

...
var I18N = {
  ...
  ui: {
    da: {
      ...
      notifDesc: 'Få besked når der tilføjes nye øvelser, refleksioner eller andet indhold til appen — direkte og relevant for dig.',
      notifToggle: 'Hold mig opdateret',
      notifEmailPlaceholder: 'Din email',
      notifSave: 'Gem',
      notifSaved: 'Tak — du hører fra os når der er noget nyt.',
      language: 'Sprog',
      langDanish: 'Dansk',
      langEnglish: 'English',
    ...
    en: {
      ...
      notifDesc: 'Get notified when new exercises, reflections or other content is added to the app — directly relevant to you.',
      notifToggle: 'Keep me updated',
      notifEmailPlaceholder: 'Your email',
      notifSave: 'Save',
      notifSaved: 'Thank you — we\'ll let you know when there\'s something new.',
      language: 'Language',
      langDanish: 'Dansk',
      langEnglish: 'English',
